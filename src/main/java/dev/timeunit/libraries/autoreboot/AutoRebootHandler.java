package dev.timeunit.libraries.autoreboot;
...
import dev.timeunit.libraries.autoreboot.listeners.AutoRebootListener;
import dev.timeunit.libraries.autoreboot.task.ServerRebootTask;
import dev.timeunit.libraries.utilities.commands.BricksCommandHandler;
...
public final class AutoRebootHandler {
    ...
    public static void init() {
        ...
        initiated = true;
        BricksCommandHandler.registerPackage(Library.getInstance(), "dev.timeunit.libraries.autoreboot.commands");
