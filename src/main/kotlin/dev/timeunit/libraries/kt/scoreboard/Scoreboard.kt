...
class Scoreboard(private val player: Player) {
    ...
    init {
        val board = _root_ide_package_.dev.timeunit.libraries.Library.getInstance().server.scoreboardManager.newScoreboard
    ...
    fun update() {
        val configuration = _root_ide_package_.dev.timeunit.libraries.Library.getInstance().scoreboardEngine.configuration!!
    ...
    private fun separate(line: String, usedBaseScores: MutableCollection<String>): Array<String> {
        ...
        when (this.separateScores.size) {
            ...
            3 -> {
                ...
                _root_ide_package_.dev.timeunit.libraries.Library.getInstance().logger.warning("Failed to separate scoreboard line. Input: $line")
            }
        }
