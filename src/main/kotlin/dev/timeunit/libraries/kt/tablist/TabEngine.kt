...
class TabEngine {
    ...
    fun load() {
        ...
        TabThread().start()
        _root_ide_package_.dev.timeunit.libraries.Library.getInstance().server.pluginManager.registerEvents(TabListeners(), _root_ide_package_.dev.timeunit.libraries.Library.getInstance())
    }
    ...
    private fun fetchSkin(): PropertyMap? {
        val propertyMap = _root_ide_package_.dev.timeunit.libraries.Library.instance.runBackboneRedisCommand { redis ->
        ...
        _root_ide_package_.dev.timeunit.libraries.Library.getInstance().runBackboneRedisCommand { redis ->
